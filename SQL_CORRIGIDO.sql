-- =============================================
-- SQL CORRIGIDO - SEM ERRO DE TIPOS
-- =============================================
-- Execute este SQL no Supabase Dashboard

-- 1. Verificar se o usuário existe nas duas tabelas (corrigido)
SELECT 'auth.users' as tabela, id, email, email_confirmed_at::text as data_info
FROM auth.users 
WHERE email = 'admin@chargeads.com'
UNION ALL
SELECT 'public.users' as tabela, id, email, created_at::text as data_info
FROM public.users 
WHERE email = 'admin@chargeads.com';

-- 2. Criar usuário na public.users se não existir
